...
class TestProcessRoutes:
    ...
    def test_process_articles_success(self, mock_pipeline, auth_headers):
        ...
        assert response.json()["job_id"] == "fake-job-123"
    ...
    def test_process_articles_unauthorized(self, mock_pipeline):
        ...
        response = client.post("/process-articles/fake-job-123")
    ...
    def test_get_processed_articles_success(self, mock_fetch, auth_headers):
        ...
        mock_fetch.return_value = {
            "status": "success", 
            "processed": 5, 
            "s3_key": "users/test_jane/processed_intelligence/fake-job-123_processed.json"
        }
        
        response = client.get("/processed-articles/fake-job-123", headers=auth_headers)
